...
% The diameter must be a fixed length: \makeheader derives \headerheight from the
% rendered tagline, and the tagline is set in the width the photo leaves over, so
% sizing the photo from \headerheight in turn would be circular. 3cm is the value
% \headerheight-\marginbottom used to give with the 4cm header set above.
\photo[round]{picture.jpg}{3cm}
...
\mainbar{
    ...
    \jobleadership{date}
        ...
        {Industry}
        {Size of the team reporting to you}
        {Work streams or tech stack you were responsible for}
        {Position Title}
